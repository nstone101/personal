            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('gallery-category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group p-0">
                                        <label for="categoryImage">{{ __('text.image') }} ({{ __('text.size') }} 600x600)(.png, .jpg, .jpeg) <span class="text-red">*</span></label>
                                        <input id="categoryImage" type="file" name="category_image" class="form-control-file">
                                    </div>
                                    <div class="card margin-top-20">
                                        ...
                                        <div class="card-body">
                                            @if ($category->category_image == '')
                                                <img src="{{ asset('fibonacci/adminpanel/assets/img/dummy/category.jpg') }}" class="img-fluid w-25 mx-auto d-block" alt="blog image">
                                            @else
                                                <img src="{{ asset('fibonacci/adminpanel/assets/img/gallery/category/'.$category->category_image) }}" class="img-fluid w-25 mx-auto d-block" alt="blog image">
                                            @endif
                                        </div>
                                    </div>
                                </div>
