    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">{{ __('text.resume') }}</h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">{{ __('text.resume') }}</h4>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header no-bd">
                                            <h5 class="modal-title">
                                                ...
                                                <span class="fw-light">{{ __('text.resume_box') }}</span>
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label for="start">{{ __('text.start_year') }} <span class="text-red">*</span></label>
                                                            <input id="start" type="number" name="start_year" class="form-control" placeholder="2014" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label for="end">{{ __('text.end_year') }} <span class="text-red">*</span></label>
                                                            <input id="end" type="number" name="end_year" class="form-control" placeholder="2018" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group form-group-default">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="add-row" class="display table table-striped table-hover" >
                                    ...
                                    @foreach ($resume_boxs as $resume_box)
                                        <tr>
                                            <th scope="row">{{ $i++ }}</th>
                                            <td><i class="{{ $resume_box->icon }}"></i></td>
                                            <td>{{ $resume_box->title }} </td>
                                            <td>{{ $resume_box->description }} </td>
                                            <td>{{ $resume_box->order }}</td>
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('resume-section.edit', $resume_box->id) }}" data-toggle="tooltip"  class="btn btn-link btn-primary btn-lg" data-original-title="{{ __('text.edit_resume') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form class="d-inline-block" action="{{ route('resume-section.destroy', $resume_box->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <span data-toggle="modal" data-target="#deleteModel{{ $resume_box->id }}">
                                                        <button type="button" data-toggle="tooltip"  class="btn btn-link btn-danger btn-lg" data-original-title="{{ __('text.remove') }}">
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                        </span>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="deleteModel{{ $resume_box->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
