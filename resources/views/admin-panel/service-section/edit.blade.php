    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">{{ __('text.edit_service') }}</h4>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('text.edit_service') }}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group p-0 margin-bottom-20 mt-0">
                                            ...
                                            <input id="icon" type="text" name="icon" class="form-control" value="{{ $service->icon }}" placeholder="fas fa-user" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group p-0 margin-bottom-20 mt-0">
                                            <label for="title">{{ __('text.title') }} <span class="text-red">*</span></label>
                                            <input id="title" type="text" name="title" class="form-control" value="{{ $service->title }}" placeholder="{{ __('text.title_here') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="form-group p-0 margin-bottom-16 mt-0">
                                            <label for="desc">{{ __('text.description') }}  <span class="text-red">*</span></label>
                                            <textarea id="desc"  name="description" class="form-control" rows="5" placeholder="{{  __('text.description_here') }}" required>{{ $service->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group p-0 margin-bottom-20 mt-0">
                                            <label for="order">{{ __('text.order') }} </label>
                                            <input id="order" type="number" name="order" class="form-control" value="{{ $service->order }}"  placeholder="{{ __('text.order_here') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
